...
class AskForLeaveAgent(ScenarioAgent):
    def __init__(self):
        super().__init__()
        self.name = "Ask for leave Agent"
        
        # 读取系统提示语，从文件中加载
        with open("prompts/ask_for_leave_prompt.txt", "r", encoding="utf-8") as file:
        ...
        # 配置字典，包含会话ID等可配置参数
        self.config = {"configurable": {"session_id": "abc12311117777"}}
